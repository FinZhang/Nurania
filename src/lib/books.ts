...
export interface BookConfig {
  ...
  /** 目录页简介区块文字 */
  intro: string;
  /** 数据目录，相对于项目根，如 "data/Nurania" 或 "data/book-2" */
  dataDir: string;
  /** 本书图片在 public 下的文件夹名，如 "Nurania" 或 "book-2" */
  publicDir: string;
  /** 书籍内页脚左侧副标题（不填则用默认） */
...
const BOOKS: BookConfig[] = [
  {
    slug: "nurania",
    title: "诺拉尼亚行思录",
    titleEn: "Under the Nuranian Skies",
    cover: "/Nurania/book_cover.png",
